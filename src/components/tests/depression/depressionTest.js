          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
            ...
            <form className="hidden lg:block">
              <p className="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-900">
                Depression is a feeling of deep sadness, hopelessness, and a
                lack of interest or pleasure in activities that lasts for a long
                time and affects a person's thoughts, feelings, and daily life.
              </p>
