export default function AboutIntroKinya() {
  return (
        ...
        <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
          <div class="text-center">
            <h1 class="text-3xl text-gray-800 font-bold sm:text-5xl lg:text-6xl lg:leading-tight dark:text-gray-200">
              Intego<span class="text-orange-600">Yacu</span>
            </h1>
          </div>
          ...
          <div class="sm:flex sm:justify-center sm:items-center text-center sm:text-left">
            ...
            <div class="pt-5 sm:pt-0 sm:pl-5">
              <div class="text-lg font-semibold text-gray-800 dark:text-gray-200">
                Mestro Mind Lab Project ni umushinga washyizweho kugirango
                hazamururwe ndetse hatangwe ubufasha mu guteza imbere ubuzima
                bwiza bwo mu mutwe ndetse no kwimakaza umuco wo kudaheza mu
                rubyiruko rwa LGBTQI+ batuye muri Kigali. Mu ruhurirane
                rw’ivangura, akato, inzitizi, guhezwa bahura nabyo uyu mushinga
                uza nkikimenyetso cy’ibyiringiro(ikizere) ndetse no kuzamura
                imibereho kubantu bakomerewe no kumenya abo baribo.
                <br />
                <br />
                Ugutangiza uyu mushinga kwavuye mu kwizera ko abantu bose
                bakwiriye kubona serivise z’ubuzima bwo mumutwe, ndetse bafite
                uburenganzira bwo kubaho neza ntabwoba. Tubaha ubumenyi
                k’ubuzima bwo mumutwe ibiganiro bifasha, kongera imibanire muri
                kominote ndetse no kubongerera ikizere, kwiyakira ndetse no
                kumva ko aho bari batekanye ndetse bakwiye kuhaba, hamwe no
                gukuraho inzitizi twimika umuco wo kudaheza aho buri rubyiruko
                rwumva ruhawe agaciro, ndetse rushyigikiwe ngo rwerekane icyo
                rushoboye, rwiteze imbere.
              </div>
            </div>
          </div>
          <div
