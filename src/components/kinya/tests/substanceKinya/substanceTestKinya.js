...
import { TestTableSubKinya } from "./testTableSubKinya";
import TestInterpretationSubKinya from "./testInterpretationSubKinya";
...
export default function SubstanceTest() {
          ...
          <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
            ...
            <form className="hidden lg:block">
              <p className="space-y-4 border-b border-gray-200 pb-6 text-sm font-medium text-gray-900">
                Substance abuse is when a person uses too many drugs or alcohol
                and it starts causing problems in their life, like health issues
                or trouble with friends and family.
              </p>
