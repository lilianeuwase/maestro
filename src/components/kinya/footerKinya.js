          ...
          <div className="md:max-w-md lg:col-span-2">
            ...
            <div className="mt-4 lg:max-w-sm">
              <p className="text-sm text-customized-6">
                Kuri Maestro Mind ibanga ryanyu ni ingenzi mugihe dutanga
                amakuru kubijyane n’ubuzima bwo mumutwe
              </p>
              <p className="mt-4 text-sm text-customized-6">
                Umutekano wamakuru ndetse nuburinzi bwayo ni ingenzi cyane kuri
                Maestro Mind.
              </p>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4 md:grid-cols-3">
            <div>
              ...
              <ul className="mt-2 space-y-2">
                ...
                <li>
                  <a
                    href="/kinyamentalhealth"
                    className="transition-colors duration-300 text-customized-6 hover:text-customized-12"
                  >
                    Amakuru K’ubuzima Bwo Mu Mutwe
                  </a>
                </li>
                <li>
                  <a
