    ...
    <div className="py-8 bg-white">
      <div className="max-w-screen-xl mx-auto px-4 flex-wrap gap-x-12 justify-between items-center md:flex md:px-8 lg:flex-nowrap">
        <div className="max-w-xl space-y-3">
          ...
          <p className="pt-8 text-black text-xl font-semibold sm:text-2xl">
        ...
        <div className="flex-none mt-12 text-white lg:mt-0">
          <div className="max-w-xl space-y-3">
            ...
            <p className="pt-4 text-black text-xl font-semibold sm:text-2xl">
              Rwanda Youth Voice for Change (RYVC)
            </p>
            <p className="text-gray-600">
              Maestro Mind Lab project is being implemented by Rwanda Youth
              Voice for Change (RYVC), RYVC is a non-political,
              non-governmental, and non-profit organization that was established
              in 2009. RYVC ‘s mission is to harness the power of data and
              human-centered design to improve the health and wellbeing of
              Rwandans, particularly youth and other under-served groups,
              through innovative solutions, research, education, and sustainable
              livelihoods, while also contributing to the achievement of SDG 3.
              RYVC believes in using evidence-based approaches to drive
              decision-making and advocacy efforts, in collaboration with other
              stakeholders and communities. By leveraging the latest
              technologies and working closely with our beneficiaries, we strive
              to create sustainable solutions that address the unique needs and
              challenges among our beneficiaries
            </p>
            <img
