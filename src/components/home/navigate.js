      ...
      <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
        <div className="flex flex-col mb-6 lg:flex-row md:mb-10">
          ...
          <div className="lg:w-1/2">
            ...
            Substance abuse is when a person uses too many drugs or alcohol and it starts causing problems in their life, like health issues or trouble with friends and family.
            </p>
          </div>
        </div>
        <div className="grid gap-8 row-gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            {/* <a
              href="/"
              aria-label=""
              className="inline-flex items-center font-semibold transition-colors duration-200 text-customized-10 hover:text-deep-purple-800"
            >
              Learn more
            </a> */}
          </div>
