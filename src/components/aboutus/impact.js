          ...
          <div class="mt-7 sm:mt-12 mx-auto max-w-xl relative">
            <div class="relative z-10 flex space-x-3 p-3 bg-white border rounded-lg shadow-lg shadow-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:shadow-gray-900/[.2]">
              <div class="flex-[1_0_0%]">
                <p class="mt-3 mb-6 text-gray-600 dark:text-gray-400 text-lg">
                  Maestro Mind Lab aims to improve access to mental health
                  services and information among LGBTQI+ youth living in Kigali
                  city
                </p>
              </div>
            </div>
