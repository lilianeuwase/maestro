...
import AboutUsKinya from "./pages/kinyaPages/aboutUsKinya";
...
const routes = [
  ...
  {
    path: "/kinyamentalhealth",
    name: "mentalhealthKinya",
    Component: MentalKinya,
  },
  ...
  {
    path: "/kinyagetinvolved",
    name: "getinvolvedKinya",
    Component: GetInvolvedKinya,
  },
  { path: "/kinyaabout-us", name: "aboutusKinya", Component: AboutUsKinya },
];
...
function App() {
  ...
  return (
    <>
      ...
      >
        <a href="https://api.whatsapp.com/send?phone=250798979117" target="_blank">
          <img
      ...
      >
        <a href="" target="_blank">
          <img
            src={require("../src/assets/warmwelcome9.png")}
            width="60"
            alt="aaaa"
          />
        </a>
